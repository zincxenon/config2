...
Updated : 25Feb16 *N* Marks New *C* Corrected/Changed
...
> yum update zsh *N*
  ...
  457  wget http://sourceforge.net/projects/zsh/files/zsh/5.0.7/zsh-5.0.7.tar.gz/download
  465  gunzip zsh-5.0.7.tar.gz
  467  tar -xvf zsh-5.0.7.tar
  471  yum install gcc
  473  yum install ncurses-devel
